        ...
        implements ValueOutputStream<ByteArrayStreamCheckpoint>
{
    ...
    public ByteArrayOutputStream(CompressionKind compression, Optional<DwrfEncryptor> dwrfEncryptor, int bufferSize)
    {
        this(compression, dwrfEncryptor, bufferSize, DATA);
    }

    public ByteArrayOutputStream(CompressionKind compression, Optional<DwrfEncryptor> dwrfEncryptor, int bufferSize, StreamKind streamKind)
    {
