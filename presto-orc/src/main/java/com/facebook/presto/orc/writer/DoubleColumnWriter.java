        ...
        implements ColumnWriter
{
    ...
    public DoubleColumnWriter(int column, Type type, CompressionKind compression, Optional<DwrfEncryptor> dwrfEncryptor, int bufferSize, MetadataWriter metadataWriter)
    {
