...
{
    static LongOutputStream createLengthOutputStream(CompressionKind compression, Optional<DwrfEncryptor> dwrfEncryptor, int bufferSize, OrcEncoding orcEncoding)
    {
        if (orcEncoding == DWRF) {
