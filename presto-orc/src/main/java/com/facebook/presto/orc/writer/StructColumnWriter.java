        ...
        implements ColumnWriter
{
    ...
    public StructColumnWriter(int column, CompressionKind compression, Optional<DwrfEncryptor> dwrfEncryptor, int bufferSize, List<ColumnWriter> structFields, MetadataWriter metadataWriter)
    {
